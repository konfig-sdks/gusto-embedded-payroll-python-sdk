...
from gusto_embedded_payroll_python_sdk.model.flows_generate_link_request import FlowsGenerateLinkRequest as FlowsGenerateLinkRequestSchema
...
from gusto_embedded_payroll_python_sdk.model.flow import Flow as FlowSchema

from gusto_embedded_payroll_python_sdk.type.flows_generate_link_request import FlowsGenerateLinkRequest
from gusto_embedded_payroll_python_sdk.type.unprocessable_entity_error_object import UnprocessableEntityErrorObject
from gusto_embedded_payroll_python_sdk.type.flow import Flow

from ...api_client import Dictionary
from gusto_embedded_payroll_python_sdk.pydantic.flow import Flow as FlowPydantic
...
from gusto_embedded_payroll_python_sdk.pydantic.flows_generate_link_request import FlowsGenerateLinkRequest as FlowsGenerateLinkRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FlowsGenerateLinkRequestSchema


request_body_flows_generate_link_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = FlowSchema
...
class BaseApi(api_client.Api):
    ...
    def _generate_link_mapped_args(
        ...
        flow_type: str,
        company_uuid: str,
        entity_uuid: typing.Optional[str] = None,
        ...
        if flow_type is not None:
            _body["flow_type"] = flow_type
        if entity_uuid is not None:
            _body["entity_uuid"] = entity_uuid
        if entity_type is not None:
            _body["entity_type"] = entity_type
        args.body = _body
    ...
    async def _agenerate_link_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/companies/{company_uuid}/flows',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_flows_generate_link_request.serialize(body, content_type)
