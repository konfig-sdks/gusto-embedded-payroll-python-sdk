...
from gusto_embedded_payroll_python_sdk.model.payrolls_submit_payroll_response import PayrollsSubmitPayrollResponse as PayrollsSubmitPayrollResponseSchema

from gusto_embedded_payroll_python_sdk.type.payrolls_submit_payroll_response import PayrollsSubmitPayrollResponse

from ...api_client import Dictionary
from gusto_embedded_payroll_python_sdk.pydantic.payrolls_submit_payroll_response import PayrollsSubmitPayrollResponse as PayrollsSubmitPayrollResponsePydantic
...
SchemaFor422ResponseBodyApplicationJson = PayrollsSubmitPayrollResponseSchema


@dataclass
class ApiResponseFor422(api_client.ApiResponse):
    body: PayrollsSubmitPayrollResponse
...
class BaseApi(api_client.Api):
    ...
    def _submit_payroll_mapped_args(
        self,
        company_id: str,
        payroll_id: str,
    ...
    async def _asubmit_payroll_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/companies/{company_id}/payrolls/{payroll_id}/submit',
            auth_settings=_auth,
            headers=_headers,
        )
...
class SubmitPayrollRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asubmit_payroll(
        self,
        company_id: str,
        payroll_id: str,
        x_gusto_api_version: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._submit_payroll_mapped_args(
            company_id=company_id,
            payroll_id=payroll_id,
            x_gusto_api_version=x_gusto_api_version,
        )
        return await self._asubmit_payroll_oapg(
    ...
    def submit_payroll(
        ...
        return self._submit_payroll_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class SubmitPayroll(BaseApi):
    ...
    async def asubmit_payroll(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asubmit_payroll(
            company_id=company_id,
            payroll_id=payroll_id,
            x_gusto_api_version=x_gusto_api_version,
            **kwargs,
    ...
    def submit_payroll(
        ...
        raw_response = self.raw.submit_payroll(
            company_id=company_id,
            payroll_id=payroll_id,
            x_gusto_api_version=x_gusto_api_version,
        )
