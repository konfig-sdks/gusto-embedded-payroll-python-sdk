...
from gusto_embedded_payroll_python_sdk.model.payrolls_calculate_gross_up422_response import PayrollsCalculateGrossUp422Response as PayrollsCalculateGrossUp422ResponseSchema

from gusto_embedded_payroll_python_sdk.type.payrolls_calculate_gross_up422_response import PayrollsCalculateGrossUp422Response

from ...api_client import Dictionary
from gusto_embedded_payroll_python_sdk.pydantic.payrolls_calculate_gross_up422_response import PayrollsCalculateGrossUp422Response as PayrollsCalculateGrossUp422ResponsePydantic
...
SchemaFor422ResponseBodyApplicationJson = PayrollsCalculateGrossUp422ResponseSchema


@dataclass
class ApiResponseFor422(api_client.ApiResponse):
    body: PayrollsCalculateGrossUp422Response
...
class BaseApi(api_client.Api):
    ...
    def _calculate_gross_up_0_mapped_args(
        self,
        company_id: str,
        payroll_id: str,
    ...
    async def _acalculate_gross_up_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/companies/{company_id}/payrolls/{payroll_id}/calculate',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _calculate_gross_up_0_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CalculateGrossUp0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acalculate_gross_up_0(
        self,
        company_id: str,
        payroll_id: str,
        x_gusto_api_version: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._calculate_gross_up_0_mapped_args(
            company_id=company_id,
            payroll_id=payroll_id,
            x_gusto_api_version=x_gusto_api_version,
        )
        return await self._acalculate_gross_up_0_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def calculate_gross_up_0(
        self,
        company_id: str,
        payroll_id: str,
        x_gusto_api_version: typing.Optional[str] = None,
        ...
        return self._calculate_gross_up_0_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class CalculateGrossUp0(BaseApi):
    ...
    async def acalculate_gross_up_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acalculate_gross_up_0(
            company_id=company_id,
            payroll_id=payroll_id,
            x_gusto_api_version=x_gusto_api_version,
            **kwargs,
    ...
    def calculate_gross_up_0(
        ...
        raw_response = self.raw.calculate_gross_up_0(
            company_id=company_id,
            payroll_id=payroll_id,
            x_gusto_api_version=x_gusto_api_version,
        )
