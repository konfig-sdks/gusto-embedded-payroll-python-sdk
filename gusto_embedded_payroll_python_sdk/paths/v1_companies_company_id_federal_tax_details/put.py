...
from gusto_embedded_payroll_python_sdk.model.federal_tax_details import FederalTaxDetails as FederalTaxDetailsSchema
from gusto_embedded_payroll_python_sdk.model.federal_tax_details_update_attributes_request import FederalTaxDetailsUpdateAttributesRequest as FederalTaxDetailsUpdateAttributesRequestSchema
...
from gusto_embedded_payroll_python_sdk.type.federal_tax_details import FederalTaxDetails
from gusto_embedded_payroll_python_sdk.type.unprocessable_entity_error_object import UnprocessableEntityErrorObject
from gusto_embedded_payroll_python_sdk.type.federal_tax_details_update_attributes_request import FederalTaxDetailsUpdateAttributesRequest

from ...api_client import Dictionary
from gusto_embedded_payroll_python_sdk.pydantic.federal_tax_details_update_attributes_request import FederalTaxDetailsUpdateAttributesRequest as FederalTaxDetailsUpdateAttributesRequestPydantic
from gusto_embedded_payroll_python_sdk.pydantic.federal_tax_details import FederalTaxDetails as FederalTaxDetailsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FederalTaxDetailsUpdateAttributesRequestSchema


request_body_federal_tax_details_update_attributes_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = FederalTaxDetailsSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FederalTaxDetails
...
class BaseApi(api_client.Api):
    ...
    def _update_attributes_mapped_args(
        ...
        tax_payer_type: typing.Optional[str] = None,
        filing_form: typing.Optional[str] = None,
        taxable_as_scorp: typing.Optional[bool] = None,
        ...
        if legal_name is not None:
            _body["legal_name"] = legal_name
        if ein is not None:
            _body["ein"] = ein
        if tax_payer_type is not None:
            _body["tax_payer_type"] = tax_payer_type
        if filing_form is not None:
            _body["filing_form"] = filing_form
        if taxable_as_scorp is not None:
            _body["taxable_as_scorp"] = taxable_as_scorp
        args.body = _body
    ...
    async def _aupdate_attributes_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/companies/{company_id}/federal_tax_details',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_federal_tax_details_update_attributes_request.serialize(body, content_type)
...
class UpdateAttributes(BaseApi):
    ...
    async def aupdate_attributes(
        ...
        **kwargs,
        ...
        if validate:
            return FederalTaxDetailsPydantic(**raw_response.body)
        return api_client.construct_model_instance(FederalTaxDetailsPydantic, raw_response.body)
