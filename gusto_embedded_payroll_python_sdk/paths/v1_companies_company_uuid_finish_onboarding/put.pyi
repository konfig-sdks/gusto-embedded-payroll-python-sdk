...
class BaseApi(api_client.Api):
    ...
    def _finish_onboarding_mapped_args(
        self,
        company_uuid: str,
    ...
    async def _afinish_onboarding_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/companies/{company_uuid}/finish_onboarding',
            auth_settings=_auth,
            headers=_headers,
        )
...
class FinishOnboardingRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afinish_onboarding(
        self,
        company_uuid: str,
        x_gusto_api_version: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._finish_onboarding_mapped_args(
            company_uuid=company_uuid,
            x_gusto_api_version=x_gusto_api_version,
        )
        return await self._afinish_onboarding_oapg(
    ...
    def finish_onboarding(
        ...
        return self._finish_onboarding_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class FinishOnboarding(BaseApi):
    ...
    async def afinish_onboarding(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afinish_onboarding(
            company_uuid=company_uuid,
            x_gusto_api_version=x_gusto_api_version,
            **kwargs,
        )
    ...
    def finish_onboarding(
        ...
        raw_response = self.raw.finish_onboarding(
            company_uuid=company_uuid,
            x_gusto_api_version=x_gusto_api_version,
        )
        if validate:
