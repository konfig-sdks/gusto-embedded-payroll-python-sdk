...
from gusto_embedded_payroll_python_sdk.model.notification import Notification as NotificationSchema

from gusto_embedded_payroll_python_sdk.type.notification import Notification
...
from gusto_embedded_payroll_python_sdk.pydantic.notification import Notification as NotificationPydantic
...
# Path params
NotificationUuidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'notification_uuid': typing.Union[NotificationUuidSchema, str, ],
    }
)
...
request_path_notification_uuid = api_client.PathParameter(
    name="notification_uuid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=NotificationUuidSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = NotificationSchema
...
class BaseApi(api_client.Api):
    ...
    async def _aget_details_oapg(
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (
            request_path_notification_uuid,
        ):
        ...
        request_before_hook(
            ...
            path_template='/v1/notifications/{notification_uuid}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetDetails(BaseApi):
    ...
    async def aget_details(
        ...
        **kwargs,
        ...
        if validate:
            return NotificationPydantic(**raw_response.body)
        return api_client.construct_model_instance(NotificationPydantic, raw_response.body)
