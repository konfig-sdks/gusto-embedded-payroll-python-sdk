...
class BaseApi(api_client.Api):
    ...
    def _get_state_taxes_mapped_args(
        self,
        employee_uuid: str,
    ...
    async def _aget_state_taxes_oapg(
        self,
...
class GetStateTaxesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_state_taxes(
        self,
        employee_uuid: str,
        x_gusto_api_version: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_state_taxes_mapped_args(
            employee_uuid=employee_uuid,
            x_gusto_api_version=x_gusto_api_version,
        )
        return await self._aget_state_taxes_oapg(
    ...
    def get_state_taxes(
        ...
        return self._get_state_taxes_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GetStateTaxes(BaseApi):
    ...
    async def aget_state_taxes(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_state_taxes(
            employee_uuid=employee_uuid,
            x_gusto_api_version=x_gusto_api_version,
            **kwargs,
        )
    ...
    def get_state_taxes(
        ...
        raw_response = self.raw.get_state_taxes(
            employee_uuid=employee_uuid,
            x_gusto_api_version=x_gusto_api_version,
        )
        if validate:
