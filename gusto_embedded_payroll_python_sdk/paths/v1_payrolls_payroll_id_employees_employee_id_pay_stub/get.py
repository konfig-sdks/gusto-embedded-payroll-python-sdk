...
class BaseApi(api_client.Api):
    ...
    def _get_employee_pay_stub_mapped_args(
        self,
        payroll_id: str,
        employee_id: str,
    ...
    async def _aget_employee_pay_stub_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/payrolls/{payroll_id}/employees/{employee_id}/pay_stub',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_employee_pay_stub_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetEmployeePayStubRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_employee_pay_stub(
        self,
        payroll_id: str,
        employee_id: str,
        x_gusto_api_version: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_employee_pay_stub_mapped_args(
            payroll_id=payroll_id,
            employee_id=employee_id,
            x_gusto_api_version=x_gusto_api_version,
        )
        return await self._aget_employee_pay_stub_oapg(
    ...
    def get_employee_pay_stub(
        ...
        return self._get_employee_pay_stub_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GetEmployeePayStub(BaseApi):
    ...
    async def aget_employee_pay_stub(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_employee_pay_stub(
            payroll_id=payroll_id,
            employee_id=employee_id,
            x_gusto_api_version=x_gusto_api_version,
            **kwargs,
    ...
    def get_employee_pay_stub(
        ...
        raw_response = self.raw.get_employee_pay_stub(
            payroll_id=payroll_id,
            employee_id=employee_id,
            x_gusto_api_version=x_gusto_api_version,
        )
