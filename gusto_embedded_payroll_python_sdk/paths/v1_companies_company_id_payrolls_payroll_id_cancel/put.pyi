...
from gusto_embedded_payroll_python_sdk.model.payroll import Payroll as PayrollSchema
...
from gusto_embedded_payroll_python_sdk.type.payroll import Payroll

from ...api_client import Dictionary
from gusto_embedded_payroll_python_sdk.pydantic.payroll import Payroll as PayrollPydantic
...
class BaseApi(api_client.Api):
    ...
    def _cancel_payroll_transition_mapped_args(
        self,
        company_id: str,
        payroll_id: str,
    ...
    async def _acancel_payroll_transition_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/companies/{company_id}/payrolls/{payroll_id}/cancel',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _cancel_payroll_transition_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CancelPayrollTransitionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acancel_payroll_transition(
        self,
        company_id: str,
        payroll_id: str,
        x_gusto_api_version: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._cancel_payroll_transition_mapped_args(
            company_id=company_id,
            payroll_id=payroll_id,
            x_gusto_api_version=x_gusto_api_version,
        )
        return await self._acancel_payroll_transition_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def cancel_payroll_transition(
        self,
        company_id: str,
        payroll_id: str,
        x_gusto_api_version: typing.Optional[str] = None,
        ...
        return self._cancel_payroll_transition_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class CancelPayrollTransition(BaseApi):
    ...
    async def acancel_payroll_transition(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acancel_payroll_transition(
            company_id=company_id,
            payroll_id=payroll_id,
            x_gusto_api_version=x_gusto_api_version,
            **kwargs,
    ...
    def cancel_payroll_transition(
        ...
        raw_response = self.raw.cancel_payroll_transition(
            company_id=company_id,
            payroll_id=payroll_id,
            x_gusto_api_version=x_gusto_api_version,
        )
