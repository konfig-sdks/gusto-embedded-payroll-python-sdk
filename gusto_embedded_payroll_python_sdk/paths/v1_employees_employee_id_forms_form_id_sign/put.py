...
from gusto_embedded_payroll_python_sdk.model.form import Form as FormSchema
...
from gusto_embedded_payroll_python_sdk.model.employee_forms_sign_form_request import EmployeeFormsSignFormRequest as EmployeeFormsSignFormRequestSchema

from gusto_embedded_payroll_python_sdk.type.employee_forms_sign_form_request import EmployeeFormsSignFormRequest
from gusto_embedded_payroll_python_sdk.type.form import Form
...
from gusto_embedded_payroll_python_sdk.pydantic.employee_forms_sign_form_request import EmployeeFormsSignFormRequest as EmployeeFormsSignFormRequestPydantic
...
from gusto_embedded_payroll_python_sdk.pydantic.form import Form as FormPydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'form_id': typing.Union[FormIdSchema, str, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = EmployeeFormsSignFormRequestSchema


request_body_employee_forms_sign_form_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _sign_form_mapped_args(
        ...
        if signature_text is not None:
            _body["signature_text"] = signature_text
        if agree is not None:
            _body["agree"] = agree
        if signed_by_ip_address is not None:
            _body["signed_by_ip_address"] = signed_by_ip_address
        args.body = _body
    ...
    async def _asign_form_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/employees/{employee_id}/forms/{form_id}/sign',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_employee_forms_sign_form_request.serialize(body, content_type)
...
class SignFormRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asign_form(
        self,
        signature_text: str,
        agree: bool,
        signed_by_ip_address: str,
        ...
        **kwargs,
        ...
        args = self._sign_form_mapped_args(
        ...
        return await self._asign_form_oapg(
            body=args.body,
    ...
    def sign_form(
        ...
        return self._sign_form_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class SignForm(BaseApi):
    ...
    async def asign_form(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asign_form(
            signature_text=signature_text,
            agree=agree,
            signed_by_ip_address=signed_by_ip_address,
            employee_id=employee_id,
    ...
    def sign_form(
        ...
        raw_response = self.raw.sign_form(
            signature_text=signature_text,
            agree=agree,
            signed_by_ip_address=signed_by_ip_address,
            employee_id=employee_id,
