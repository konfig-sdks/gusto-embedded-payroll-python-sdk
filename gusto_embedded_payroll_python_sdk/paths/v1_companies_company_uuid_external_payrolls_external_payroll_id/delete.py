...
class BaseApi(api_client.Api):
    ...
    def _delete_payroll_mapped_args(
        self,
        company_uuid: str,
    ...
    async def _adelete_payroll_oapg(
        self,
...
class DeletePayrollRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_payroll(
        self,
        company_uuid: str,
        external_payroll_id: str,
        x_gusto_api_version: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._delete_payroll_mapped_args(
            company_uuid=company_uuid,
            external_payroll_id=external_payroll_id,
            x_gusto_api_version=x_gusto_api_version,
        )
        return await self._adelete_payroll_oapg(
    ...
    def delete_payroll(
        ...
        return self._delete_payroll_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class DeletePayroll(BaseApi):
    ...
    async def adelete_payroll(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_payroll(
            company_uuid=company_uuid,
            external_payroll_id=external_payroll_id,
            x_gusto_api_version=x_gusto_api_version,
            **kwargs,
    ...
    def delete_payroll(
        ...
        raw_response = self.raw.delete_payroll(
            company_uuid=company_uuid,
            external_payroll_id=external_payroll_id,
            x_gusto_api_version=x_gusto_api_version,
        )
