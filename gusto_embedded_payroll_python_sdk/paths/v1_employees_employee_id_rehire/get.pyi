...
class GetRehireRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_rehire(
        self,
        employee_id: str,
        x_gusto_api_version: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_rehire_mapped_args(
            employee_id=employee_id,
            x_gusto_api_version=x_gusto_api_version,
        )
        return await self._aget_rehire_oapg(
    ...
    def get_rehire(
        ...
        return self._get_rehire_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GetRehire(BaseApi):
    ...
    async def aget_rehire(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_rehire(
            employee_id=employee_id,
            x_gusto_api_version=x_gusto_api_version,
            **kwargs,
        )
    ...
    def get_rehire(
        ...
        raw_response = self.raw.get_rehire(
            employee_id=employee_id,
            x_gusto_api_version=x_gusto_api_version,
        )
        if validate:
