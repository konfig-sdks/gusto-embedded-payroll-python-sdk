...
class RequiredPayrollReceiptLicensee(TypedDict):
    pass

class OptionalPayrollReceiptLicensee(TypedDict, total=False):
...
class PayrollReceiptLicensee(RequiredPayrollReceiptLicensee, OptionalPayrollReceiptLicensee):
    pass
