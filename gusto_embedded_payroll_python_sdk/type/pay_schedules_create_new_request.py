...
class RequiredPaySchedulesCreateNewRequest(TypedDict):
...
class OptionalPaySchedulesCreateNewRequest(TypedDict, total=False):
...
class PaySchedulesCreateNewRequest(RequiredPaySchedulesCreateNewRequest, OptionalPaySchedulesCreateNewRequest):
    pass
