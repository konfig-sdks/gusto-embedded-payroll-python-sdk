...
class RequiredEmployeeBenefitsUpdateBenefitRecordRequest(TypedDict):
    # The current version of the object. See the [versioning guide](https://docs.gusto.com/embedded-payroll/docs/versioning#object-layer) for information on how to use this field.
    version: str

class OptionalEmployeeBenefitsUpdateBenefitRecordRequest(TypedDict, total=False):
...
class EmployeeBenefitsUpdateBenefitRecordRequest(RequiredEmployeeBenefitsUpdateBenefitRecordRequest, OptionalEmployeeBenefitsUpdateBenefitRecordRequest):
    pass
