...
class RequiredTimeOffPoliciesCreatePolicyRequest(TypedDict):
...
class OptionalTimeOffPoliciesCreatePolicyRequest(TypedDict, total=False):
...
class TimeOffPoliciesCreatePolicyRequest(RequiredTimeOffPoliciesCreatePolicyRequest, OptionalTimeOffPoliciesCreatePolicyRequest):
    pass
