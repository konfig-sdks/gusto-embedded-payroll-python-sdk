...
class RequiredCompanyBenefitsCreateBenefitRequest(TypedDict):
...
class OptionalCompanyBenefitsCreateBenefitRequest(TypedDict, total=False):
...
class CompanyBenefitsCreateBenefitRequest(RequiredCompanyBenefitsCreateBenefitRequest, OptionalCompanyBenefitsCreateBenefitRequest):
    pass
