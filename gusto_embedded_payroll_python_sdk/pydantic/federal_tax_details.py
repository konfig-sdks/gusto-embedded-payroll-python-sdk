...
class FederalTaxDetails(BaseModel):
    ...
    tax_payer_type: typing.Optional[str] = Field(None, alias='tax_payer_type')
    ...
    has_ein: typing.Optional[bool] = Field(None, alias='has_ein')

    # Whether the EIN was able to be verified as a valid EIN with the IRS. 
    ein_verified: typing.Optional[bool] = Field(None, alias='ein_verified')
