...
from gusto_embedded_payroll_python_sdk.pydantic.employee_benefits_update_benefit_record_request_contribution import EmployeeBenefitsUpdateBenefitRecordRequestContribution

class EmployeeBenefitsUpdateBenefitRecordRequest(BaseModel):
    ...
    contribution: typing.Optional[EmployeeBenefitsUpdateBenefitRecordRequestContribution] = Field(None, alias='contribution')
