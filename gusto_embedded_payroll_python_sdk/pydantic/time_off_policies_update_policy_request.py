...
class TimeOffPoliciesUpdatePolicyRequest(BaseModel):
    # Name of the time off policy
    name: typing.Optional[str] = Field(None, alias='name')

    # Accrual method of the time off policy
    accrual_method: typing.Optional[Literal["unlimited", "per_pay_period", "per_calendar_year", "per_anniversary_year", "per_hour_worked", "per_hour_worked_no_overtime", "per_hour_paid", "per_hour_paid_no_overtime"]] = Field(None, alias='accrual_method')
