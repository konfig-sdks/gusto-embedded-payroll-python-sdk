...
class HolidayPayPoliciesCreateCompanyPolicyRequestFederalHolidaysIndependenceDay(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["selected", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["selected", ], str]):
    ...
    ) -> 'HolidayPayPoliciesCreateCompanyPolicyRequestFederalHolidaysIndependenceDay':
