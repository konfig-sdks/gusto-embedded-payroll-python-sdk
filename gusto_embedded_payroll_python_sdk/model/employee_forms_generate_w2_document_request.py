...
class EmployeeFormsGenerateW2DocumentRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["employee_id", "year", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["employee_id", "year", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        employee_id: typing.Union[MetaOapg.properties.employee_id, str, ],
