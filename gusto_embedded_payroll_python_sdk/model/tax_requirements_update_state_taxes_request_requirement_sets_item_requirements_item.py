...
class TaxRequirementsUpdateStateTaxesRequestRequirementSetsItemRequirementsItem(
    schemas.DictSchema
):
    """
    ...
    ) -> 'TaxRequirementsUpdateStateTaxesRequestRequirementSetsItemRequirementsItem':
        return super().__new__(
            cls,
            *args,
            key=key,
