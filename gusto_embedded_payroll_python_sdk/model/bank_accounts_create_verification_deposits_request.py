...
class BankAccountsCreateVerificationDepositsRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["routing_number", "account_number", "account_type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["routing_number", "account_number", "account_type", ], str]):
