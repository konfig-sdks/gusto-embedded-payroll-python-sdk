...
class TimeOffPoliciesCreatePolicyRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "policy_type", "accrual_method", "accrual_rate", "accrual_rate_unit", "paid_out_on_termination", "accrual_waiting_period_days", "carryover_limit_hours", "max_accrual_hours_per_year", "max_hours", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "policy_type", "accrual_method", "accrual_rate", "accrual_rate_unit", "paid_out_on_termination", "accrual_waiting_period_days", "carryover_limit_hours", "max_accrual_hours_per_year", "max_hours", ], str]):
