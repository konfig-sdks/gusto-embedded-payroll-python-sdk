...
class TimeOffPoliciesUpdateEmployeeBalanceRequestEmployeesItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["uuid", "balance", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["uuid", "balance", ], str]):
    ...
    ) -> 'TimeOffPoliciesUpdateEmployeeBalanceRequestEmployeesItem':
