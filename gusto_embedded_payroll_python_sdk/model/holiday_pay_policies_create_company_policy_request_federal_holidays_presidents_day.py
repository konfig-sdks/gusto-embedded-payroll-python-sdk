...
class HolidayPayPoliciesCreateCompanyPolicyRequestFederalHolidaysPresidentsDay(
    schemas.DictSchema
):
    """
    ...
    ) -> 'HolidayPayPoliciesCreateCompanyPolicyRequestFederalHolidaysPresidentsDay':
