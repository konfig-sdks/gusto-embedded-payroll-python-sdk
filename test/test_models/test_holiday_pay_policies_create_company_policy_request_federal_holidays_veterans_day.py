...
class TestHolidayPayPoliciesCreateCompanyPolicyRequestFederalHolidaysVeteransDay(unittest.TestCase):
    """HolidayPayPoliciesCreateCompanyPolicyRequestFederalHolidaysVeteransDay unit test stubs"""
    pass
