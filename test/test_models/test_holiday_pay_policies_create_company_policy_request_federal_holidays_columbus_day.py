...
class TestHolidayPayPoliciesCreateCompanyPolicyRequestFederalHolidaysColumbusDay(unittest.TestCase):
    """HolidayPayPoliciesCreateCompanyPolicyRequestFederalHolidaysColumbusDay unit test stubs"""
    pass
