...
class TestHolidayPayPoliciesCreateCompanyPolicyRequestFederalHolidaysChristmasDay(unittest.TestCase):
    """HolidayPayPoliciesCreateCompanyPolicyRequestFederalHolidaysChristmasDay unit test stubs"""
    pass
