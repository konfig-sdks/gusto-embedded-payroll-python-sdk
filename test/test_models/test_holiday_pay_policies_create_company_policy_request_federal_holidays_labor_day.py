...
class TestHolidayPayPoliciesCreateCompanyPolicyRequestFederalHolidaysLaborDay(unittest.TestCase):
    """HolidayPayPoliciesCreateCompanyPolicyRequestFederalHolidaysLaborDay unit test stubs"""
    pass
