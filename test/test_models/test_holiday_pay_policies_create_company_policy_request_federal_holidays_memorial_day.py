...
class TestHolidayPayPoliciesCreateCompanyPolicyRequestFederalHolidaysMemorialDay(unittest.TestCase):
    """HolidayPayPoliciesCreateCompanyPolicyRequestFederalHolidaysMemorialDay unit test stubs"""
    pass
