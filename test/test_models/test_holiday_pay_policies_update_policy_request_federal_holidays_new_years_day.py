...
class TestHolidayPayPoliciesUpdatePolicyRequestFederalHolidaysNewYearsDay(unittest.TestCase):
    """HolidayPayPoliciesUpdatePolicyRequestFederalHolidaysNewYearsDay unit test stubs"""
    pass
