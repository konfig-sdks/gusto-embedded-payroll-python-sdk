...
class TestHolidayPayPoliciesCreateCompanyPolicyRequestFederalHolidaysNewYearsDay(unittest.TestCase):
    """HolidayPayPoliciesCreateCompanyPolicyRequestFederalHolidaysNewYearsDay unit test stubs"""
    pass
